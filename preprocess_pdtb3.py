...
# run preprocess_pdtb3.py --data_dir ./data/ --output_dir ./output/ --split L1_ji
# output:{'Expansion': 10152, 'Comparison': 2301, 'Contingency': 7027, 'Temporal': 1738}
# train: 17945  Sec. 2-20   (Comp. 1937, Con. 5916, Exp. 8645, Temp. 1447) 
# dev:  1653 Sec. 0-1  (Comp. 190+11, Con. 579+1, Exp. 748+63, Temp. 136+4)
# test: 1474 Sec. 21-22  (Comp. 154+9, Con. 529+2, Exp. 643+53, Temp. 148+3)
